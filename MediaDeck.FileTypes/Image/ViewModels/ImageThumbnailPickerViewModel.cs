...
public class ImageThumbnailPickerViewModel(BaseThumbnailPickerModel thumbnailPickerModel, ImageFileOperator imageFileOperator) : BaseThumbnailPickerViewModel(thumbnailPickerModel) {
